...
# ---------------------------------------------------------------- doctors
# Placeholder phone numbers (obviously non-dialable test data)
DOCTORS = [
    # (name, specialty, title, phone, hire_date, salary)
    ("王建国", "内科", "主任医师", "00000000001", date(2012, 3, 1), 28000.00),
    ("李秀兰", "外科", "副主任医师", "00000000002", date(2014, 7, 15), 25000.00),
    ("张伟", "皮肤科", "主治医师", "00000000003", date(2017, 2, 20), 18000.00),
    ("刘芳", "牙科", "主治医师", "00000000004", date(2018, 9, 10), 17000.00),
    ("陈强", "眼科", "副主任医师", "00000000005", date(2015, 5, 25), 22000.00),
    ("赵敏", "心脏科", "主任医师", "00000000006", date(2010, 11, 5), 32000.00),
    ("孙磊", "骨科", "主治医师", "00000000007", date(2019, 4, 18), 16000.00),
    ("周静", "营养科", "主治医师", "00000000008", date(2020, 1, 8), 15000.00),
]
...
def gen_owners(count=30):
    ...
    for i in range(count):
        # obviously non-dialable placeholder, unique per owner
        phone = f"0000000{count:02d}{i + 1:02d}"
        owners.append({
            "name": _random_name(),
            "phone": phone,
